...
def fetch_ctms(conn, month, limit=50, ctm_id=None):
...
def main():
    ...
    print("CTM Narrative Extraction")
    print("=" * 50)

    conn = get_db_connection()

    ctms = fetch_ctms(conn, args.month or "", args.limit, args.ctm)
    ...
    stats = {"ctms": 0, "narratives": 0, "failed": 0}
    total_tok_in = 0
    total_tok_out = 0
    ...
    print(
        ...
        % (stats["ctms"], stats["narratives"], stats["failed"])
    )
