...
def load_feeds_from_csv():
    ...
    with open(feeds_csv_path, 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            feed_data = {
                ...
                'country_code': row['country_code'].strip()[:3] if row['country_code'].strip() else None,  # Truncate to 3 chars
    ...
    with engine.connect() as conn:
        ...
        logger.info(f"  - Total feeds in database: {inserted_count + len(existing_urls)}")
