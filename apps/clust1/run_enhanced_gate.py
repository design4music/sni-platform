            ...
            try:
                ...
                if not dry_run:
                    ...
                    with get_db_session() as session:
                        ...
                        # Build gate_reason
                        if is_strategic:
                            gate_reason = f"Strategic: {len(entities['actors'])} entities"
                            gate_actor_hit = entities['actors'][0] if entities['actors'] else None
                        else:
                            if entities['actors']:
...
async def main():
    ...
    parser.add_argument("--hours", type=int, default=24, help="Process titles from last N hours")
