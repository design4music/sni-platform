...
def reset_to_pending():
    ...
    with engine.connect() as conn:
        ...
        logger.info(f"Before reset: {before.pending} pending, {before.gated} gated, {before.total} total")
        ...
        logger.info(f"After reset: {after.pending} pending, {after.gated} gated, {after.total} total")
