...
export default function RaiSidebar({ signals, stats }: RaiSidebarProps) {
  ...
  return (
    <div className="bg-dashboard-surface border border-dashboard-border rounded-lg p-4 space-y-4">
      <h3 className="text-lg font-semibold text-dashboard-text">RAI Analysis</h3>

      {/* Adequacy */}
      <div>
        <div className="flex items-center justify-between mb-1.5">
          <span className="text-xs font-semibold text-dashboard-text-muted uppercase tracking-wide">Adequacy</span>
        ...
        <p className="text-xs text-dashboard-text-muted leading-relaxed">{signals.adequacy_reason}</p>
      </div>
      ...
      {signals.framing_bias && (
        <div>
          ...
          <p className="text-xs text-dashboard-text-muted leading-relaxed">{signals.framing_bias}</p>
        </div>
      )}
      ...
      {signals.follow_the_gain && (
        <div>
          ...
          <p className="text-xs text-dashboard-text-muted leading-relaxed">{signals.follow_the_gain}</p>
        </div>
      )}
    </div>
  );
