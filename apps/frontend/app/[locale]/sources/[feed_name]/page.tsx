        ...
        <div className="mb-8 pb-8 border-b border-dashboard-border">
          ...
          <div className="flex gap-8 mt-6">
            <div>
              ...
              <div className="text-sm text-dashboard-text-muted">{tSources('articles')}</div>
            </div>
            <div>
              <div className="text-2xl font-bold">{profile.centroid_coverage.length}</div>
              <div className="text-sm text-dashboard-text-muted">{tSources('regionsCovered')}</div>
            </div>
            <div>
              <div className="text-2xl font-bold">{profile.top_ctms.length}</div>
              <div className="text-sm text-dashboard-text-muted">{tSources('activeTopics')}</div>
            </div>
          </div>
        </div>
                ...
                return (
                  ...
                  >
                    <span className="text-sm w-48 truncate text-dashboard-text group-hover:text-blue-400 transition">
                      {getCentroidLabel(c.centroid_id, c.label, tCentroids)}
                    </span>
