...
async def test_simplified_extraction():
    ...
    extracted = await fetcher._extract_article_content(test_html, "https://example.com/test")
...
async def test_learned_profile_integration():
    ...
    content = await fetcher._extract_article_content(test_html, "https://timesofindia.indiatimes.com/test")
